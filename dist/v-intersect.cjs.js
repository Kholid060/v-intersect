...
var intersectComponent = {
  ...
  setup(props, { slots, emit }) {
    ...
    vue.onMounted(createObserver);
    vue.onUnmounted(destroyObserver);
...
exports.VIntersectComp = VIntersectComp;
exports.VIntersectDir = VIntersectDir;
